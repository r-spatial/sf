...
#>   `/tmp/Rtmpi7Ct3Y/nc.shp' using driver `ESRI Shapefile'
...
#> Writing layer `meuse' to data source `/tmp/Rtmpi7Ct3Y/meuse.csv' using driver `CSV'
#> options:        GEOMETRY=AS_XY 
#> Writing 155 features with 12 fields and geometry type Point.
#> Deleting source `/tmp/Rtmpi7Ct3Y/meuse.csv' using driver `CSV'
#> Writing layer `meuse' to data source `/tmp/Rtmpi7Ct3Y/meuse.csv' using driver `CSV'
