...
#>   `/tmp/RtmpjGEtrA/nc.shp' using driver `ESRI Shapefile'
...
#> Writing layer `meuse' to data source `/tmp/RtmpjGEtrA/meuse.csv' using driver `CSV'
#> options:        GEOMETRY=AS_XY 
#> Writing 155 features with 12 fields and geometry type Point.
#> Deleting source `/tmp/RtmpjGEtrA/meuse.csv' using driver `CSV'
#> Writing layer `meuse' to data source `/tmp/RtmpjGEtrA/meuse.csv' using driver `CSV'
