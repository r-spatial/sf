...
has given several tutorials on this topic, for instance on several of
the yearly [geostat](http://geostat-course.org/) summer schools, but
the tutorial material on analyzing trajectory (movement) data is new.

Edzer's [google scholar page](https://scholar.google.de/citations?user=d6jdqdQAAAAJ&hl=en).
