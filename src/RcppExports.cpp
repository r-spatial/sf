...
// CPL_get_zbox
Rcpp::NumericVector CPL_get_zbox(Rcpp::List sf, int depth);
RcppExport SEXP _sf_CPL_get_zbox(SEXP sfSEXP, SEXP depthSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::List >::type sf(sfSEXP);
    Rcpp::traits::input_parameter< int >::type depth(depthSEXP);
    rcpp_result_gen = Rcpp::wrap(CPL_get_zbox(sf, depth));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_sf_CPL_get_zbox", (DL_FUNC) &_sf_CPL_get_zbox, 2},
