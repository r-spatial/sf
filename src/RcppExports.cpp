...
// CPL_geos_is_simple
Rcpp::LogicalVector CPL_geos_is_simple(Rcpp::List sfc, size_t threads);
RcppExport SEXP _sf_CPL_geos_is_simple(SEXP sfcSEXP, SEXP threadsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::List >::type sfc(sfcSEXP);
    Rcpp::traits::input_parameter< size_t >::type threads(threadsSEXP);
    rcpp_result_gen = Rcpp::wrap(CPL_geos_is_simple(sfc, threads));
    return rcpp_result_gen;
END_RCPP
}
// CPL_geos_is_empty
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_sf_CPL_geos_is_simple", (DL_FUNC) &_sf_CPL_geos_is_simple, 2},
