...
extern SEXP sf_CPL_geohash(SEXP, SEXP);
...
extern SEXP sf_RcppExport_registerCCallable();
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"sf_CPL_geohash",                  (DL_FUNC) &sf_CPL_geohash,                   2},
    ...
    {"sf_RcppExport_registerCCallable", (DL_FUNC) &sf_RcppExport_registerCCallable,  0},
    {NULL, NULL, 0}
};
