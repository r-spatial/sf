...
st_crop(pol, box)
# 3.14: POLYGON ((0.983044 0.0650651, 0.959619 0.040380...
# 3.15: POLYGON ((1 0.0849179, 0.983044 0.0650651, 0.95...
st_crop(pol, st_bbox(box))
# 3.14: POLYGON ((0.983044 0.0650651, 0.959619 0.040380...
# 3.15: POLYGON ((1 0.0849179, 0.983044 0.0650651, 0.95...
st_crop(pol_sf, box)
# 3.14: POLYGON ((0.983044 0.065065...
# 3.15: POLYGON ((1 0.0849179, 0.98...
