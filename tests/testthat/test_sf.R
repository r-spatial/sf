...
test_that("dropzm works", {
  ...
  expect_identical(pt, st_dropzm(ptz))
  expect_identical(pt, st_dropzm(ptm))
  expect_identical(pt, st_dropzm(ptzm))
  expect_identical(pl, st_dropzm(plz))
  expect_identical(pl, st_dropzm(plm))
  expect_identical(pl, st_dropzm(plzm))
  expect_identical(st_sfc(pt,pl), st_dropzm(st_sfc(ptz,plz)))
  expect_identical(st_sfc(pt,pl), st_dropzm(st_sfc(ptm,plm)))
  expect_identical(st_sfc(pt,pl), st_dropzm(st_sfc(ptzm,plzm)))
  expect_identical(st_sf(a = 1:2, geom = st_sfc(pt,pl)), st_dropzm(st_sf(a = 1:2, geom = st_sfc(ptzm,plzm))))
})
