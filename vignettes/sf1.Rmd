...
(Note that users will not use \code{system.file} but give a \code{filename} directly, and that shapefiles consist of more than one file, all with identical basename, which reside in the same directory.)
...
([JTS](http://tsusiatsoftware.net/jts/main.html)), and works like this:
...
On a modern laptop (with an Intel i7-7500U CPU @ 2.70GHz processor) the results were as follows:

```
Unit: milliseconds
          expr        min         lq       mean     median         uq        max neval
shp_read_sp() 5651.72699 5651.72699 5651.72699 5651.72699 5651.72699 5651.72699     1
shp_read_sf()  398.64002  398.64002  398.64002  398.64002  398.64002  398.64002     1
kmz_read_sp() 5838.50189 5838.50189 5838.50189 5838.50189 5838.50189 5838.50189     1
kmz_read_sf() 1234.79294 1234.79294 1234.79294 1234.79294 1234.79294 1234.79294     1
kml_read_sp()  156.82933  156.82933  156.82933  156.82933  156.82933  156.82933     1
kml_read_sf()   10.27719   10.27719   10.27719   10.27719   10.27719   10.27719     1
```

This shows that `sf::st_read()` is
substantially faster than `rgdal::readOGR()`: by more than a factor of 10
for the Shapefile and KML files, and more than a factor of 3 for the KMZ file
used in this benchmark, respectively.
...
```{r}
nc <- st_read(system.file("shape/nc.shp", package="sf"),
    relation_to_geometry = c(AREA = "aggregate", PERIMETER = "aggregate", CNTY_ = "identity",
