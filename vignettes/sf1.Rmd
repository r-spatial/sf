...
On a modern laptop (with an Intel i5-2520M processor) the results were as follows:
...
##  kmz_read_sf() 2096.9094 2096.9094 2096.9094 2096.9094 2096.9094 2096.9094
```
...
| value | meaning                           |
|-------| ----------------------------------|
| constant | a variable that has a constant value at every location over a spatial extent; examples: elevation, temperature, land use |
| aggregate | values are summary values (aggregates) over the geometry, e.g. population density, dominant land use | 
| identity | values identify the geometry, and refer to (the whole of) this geometry and to no other geometry |
