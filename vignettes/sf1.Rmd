...
reference system (CRS) is known; this may be a spheroid CRS such as [WGS84](https://gisgeography.com/wgs84-world-geodetic-system/), a projected, two-dimensional (Cartesian) CRS such as a UTM zone or Web Mercator, or a CRS
...
As we usually do not work with geometries of single _simple features_,
