...
This shows that `sf::st_read()` is not only simpler to use but also
substantially faster than `rgdal::readOGR()`: by a factor of 3 and 10
for the Shapefile and KML file used in this benchmark, respectively.
