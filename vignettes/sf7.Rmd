...
from the full polygon representing the globe,
```{r eval=s2_available}
...
We can from this calculate the proportion of the Earth's surface covered by oceans:
...
uk_sf = st_as_sf(uk) # fails, should this not work?
```
...
excessive simplification (bottom right).
...
deciding on workflows and 
selecting appropriate levels of level of geographic resolution can
