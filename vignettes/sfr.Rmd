...
```
Benchmarks demonstrate that `st_read()` is much faster than `rgdal::readOGR()`.
...
microbenchmark::microbenchmark(sp_shp_read(), sf_shp_read(),
...
`st_buffer`, `st_boundary`, `st_convexhull`, `st_union_cascaded`,
