...
[rgeos](https://CRAN.R-project.org/package=rgeos)), but so far lacked a
...
Note that `CIRCULASTRING`, `COMPOUNDCURVE` and `CURVEPOLYGON` are not described in the SFA standard,but in the SQL-MM part 3 standard. The descriptions above were copied from the [postgis](http://postgis.net/docs/using_postgis_dbmanagement.html) docs.
