...
There is no inherent property of features that makes them simple,
but _simple features_ refers to a standard to describe them, that
necesarily has to put some constraints. The constraints refer to

* geometry dimensions
* simple feature geometry types
* excluded (non-simple) geometries
...
plot(a)
plot(b, add = TRUE, border = 'red')
plot(st_sfc(i), add = TRUE, col = 'green', lwd = 2)
par(opar)
```
